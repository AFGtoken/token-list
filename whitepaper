...
Instead of permanently locking LP tokens, Afghan.coin applies a flexible liquidity strategy. Liquidity is actively managed to stabilize price, reduce volatility, and ensure sustainable growth. This approach allows the project to adapt to market conditions, integrate market-making bots, and balance reserves between SOL and USDC pairs.
